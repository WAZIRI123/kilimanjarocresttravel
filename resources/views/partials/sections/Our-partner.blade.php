        ...
        <div class="py-16 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8 lg:w-3/4 lg:mx-auto">
                    <!-- Card 1 -->
                    <div class="group relative rounded-xl border border-gray-200 p-6 shadow-sm transition-all hover:shadow-md hover:-translate-y-1 bg-gray-900 backdrop-blur-xsm">
                        ...
                        <h3 class="text-xl font-semibold text-white mb-2">Expertly Curated Experiences</h3>
                        <p class="text-white">Our team of travel experts handpicks each destination and activity to ensure unforgettable memories and authentic cultural immersion.</p>
                    </div>

                    <!-- Card 2 -->
                    <div class="group relative bg-gray-900 backdrop-blur-xsm rounded-xl border border-gray-200 p-6 shadow-sm transition-all hover:shadow-md hover:-translate-y-1">
                        ...
                        <p class="text-white">From flights to accommodations and activities, we handle all the details so you can focus on enjoying your journey.</p>
                    </div>
                    ...
                    <div class="group relative bg-gray-900 backdrop-blur-xsm rounded-xl border border-gray-200 p-6 shadow-sm transition-all hover:shadow-md hover:-translate-y-1">
                        ...
                        <p class="text-white">With our extensive local knowledge, we provide insider access to hidden gems and unique experiences you won't find in guidebooks.</p>
                    </div>
                </div>
            </div>
        </div>
