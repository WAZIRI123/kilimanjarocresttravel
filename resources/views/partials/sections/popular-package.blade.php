        ...
        @foreach($tabs as $tab)
            <div x-show="activeTab === '{{ $tab['id'] }}'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div class="group relative bg-white rounded-xl border-gray-300 overflow-hidden transition-all duration-300  shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6">
                                <a href="/packages/{{ $package['slug'] }}" class="w-full inline-flex justify-center items-center px-6 py-3 border ring-offset-background border-transparent text-white text-lg font-medium rounded-md outline-double outline-1 outline-gray-300  bg-amber-600 hover:bg-amber-700 transition-colors duration-200">
                                    Book Now
                ...
                <div class="mt-10 text-center">
                    <a href="{{ route('all-packages', ['category' => $tab['name']]) }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-amber-600 hover:bg-amber-700 transition-colors duration-200">
