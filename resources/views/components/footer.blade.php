        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div class="flex justify-center lg:justify-start space-x-4 mt-3">
                    ...
                    <a href="https://www.instagram.com/crownedwildafrica/" class="text-muted-foreground hover:text-foreground transition-colors">
                    ...
                    <a href="https://www.youtube.com/@CrownedWildAfrica" class="text-muted-foreground hover:text-foreground transition-colors">
