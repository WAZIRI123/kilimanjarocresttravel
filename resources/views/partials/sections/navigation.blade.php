    <!-- Navigation -->
    <nav class="relative z-40 bg-transparent" style="width:100%">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                <!-- Logo -->
                <div class="flex-shrink-0">
                    <a href="/" class="text-white text-2xl font-bold">
                        <img src="{{ asset('images/image-used/crownlogo1.PNG') }}" alt="Stan Safaris Tanzania" class="logo-img w-30 h-auto pt-3">
                    </a>
                </div>
                    ...
                    <div class="flex items-center space-x-1  rounded-full px-6 py-2 backdrop-blur-sm">
                        ...
                        <div x-data="{ open: false }" 
                            ...
                            <button 
                                ...
                                class="flex items-center text-white {{ request()->is('all-packages*') ? 'bg-white/10' : 'hover:bg-white/10' }} px-4 py-2 rounded-full text-lg font-medium transition-colors"
                                :aria-expanded="open">
                                Safaris
                            ...
                            <div x-show="open"
                                ...
                                <div class="p-2 space-y-1">
                                    <a {{ !request('category') ? 'active' : '' }}" href="{{ route('all-packages') }}" class="flex items-center px-4 py-1 text-sm hover:bg-gray-100 rounded-md transition-colors text-black">
                                        All Packages
                                    </a>
                        ...
                        <div x-data="{ open: false }" 
                            ...
                            <div x-show="open"
                                ...
                                style="display: none;">
                                <div class="p-2 space-y-1">
                                    <a href="/climbing/kilimanjaro" class="flex items-center px-4 py-1 text-sm hover:bg-gray-100 rounded-md transition-colors text-black">
                                        Mount Kilimanjaro
                                    </a>
                                    <a href="/climbing/meru" class="flex items-center px-4 py-1 text-sm hover:bg-gray-100 rounded-md transition-colors text-black">
                                        Mount Meru
                                    </a>
                                </div>
                            </div>
                        ...
                        <div x-data="{ open: false }" 
                            ...
                            <div x-show="open"
                                ...
                                style="display: none;">
                                <div class="p-2 space-y-1">
                                    <a href="/beaches/zanzibar" class="flex items-center px-4 py-1 text-sm hover:bg-gray-100 rounded-md transition-colors text-black">
                                        Zanzibar
                                    </a>
                                    <a href="/beaches/pemba" class="flex items-center px-4 py-1 text-sm hover:bg-gray-100 rounded-md transition-colors text-black">
                                        Pemba Island
                                    </a>
                                    <a href="/beaches/mafia" class="flex items-center px-4 py-1 text-sm hover:bg-gray-100 rounded-md transition-colors text-black">
                                        Mafia Island
                                    </a>
                                </div>
                            </div>
