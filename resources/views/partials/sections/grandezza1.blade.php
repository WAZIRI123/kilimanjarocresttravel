...
<section class="relative h-screen w-full overflow-hidden reveal-card" x-data="{ zanzibarQuoteModal: false }">
    ...
    <div class="relative z-10 flex flex-col items-center justify-start h-full px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mt-4 flex flex-row lg:gap-8 gap-3 justify-center pt-[10%]">
               <button @click="zanzibarQuoteModal = true"
            ...
            <a href="{{ route('all-packages',['category'=>'zanzibar']) }}" class="inline-block bg-white hover:bg-gray-100 text-gray-800 px-3 py-2 rounded-sm transition-colors text-center text-[15px]" style="font-family: 'brandon-bold-webfont', sans-serif; letter-spacing: 1.84px;">
                Learn More
            </a>
        </div>
      
      @include('partials.sections.quick-quote',['modalName'=>'zanzibarQuoteModal'])
    </div>
</section>